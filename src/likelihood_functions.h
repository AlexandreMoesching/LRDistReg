...
void vgamma_tilde1_ref_cpp(arma::mat& theta, const par& par);
void vgamma_tilde2_ref_cpp(arma::mat& theta, const par& par);
...
double f_theta_cpp(arma::mat theta, int n, arma::mat w, arma::imat PP);
